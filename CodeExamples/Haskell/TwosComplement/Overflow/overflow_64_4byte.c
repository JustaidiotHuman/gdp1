...
int main() {
  assert(sizeof(int) == 4);
  // The value 0x 80 00 00 00 is the
  // minimal integer for signed integer with 4 byte
  assert(INT_MIN == 0x80000000);
   int x   = INT_MIN;
   int y   = INT_MIN;
  ...
  //
  // gcc -S -Wall overflow_64_4byte.c
  // view overflow_64_4byte.s
  //
  // gcc -S -Wall overflow_64_4byte.c -fsanitize=undefined
  // view overflow_64_4byte.s
